...
-- 插入测试用户
-- 注意：密码使用明文存储，实际生产环境应使用BCrypt加密
INSERT INTO users (username, password, role_name, phone, gender, age, address, avatar) VALUES
('elder_demo', '123456', '老人', '13800138001', '男', 65, '北京市朝阳区', '/static/images/avatar/elder.jpg'),
('volunteer_demo', '123456', '志愿者', '13800138002', '女', 28, '北京市海淀区', '/static/images/avatar/volunteer.jpg'),
('admin_demo', '123456', '管理员', '13800138003', '男', 35, '北京市西城区', '/static/images/avatar/admin.jpg');
